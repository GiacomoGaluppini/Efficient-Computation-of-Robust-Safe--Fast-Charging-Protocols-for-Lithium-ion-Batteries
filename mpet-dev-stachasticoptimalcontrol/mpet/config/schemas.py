...
system = {'Sim Params': {'profileType': lambda x:
                        ...
                        #use backoff for constraints #GG2
                        Optional('useBackoff', default=False):Use(tobool),
                        Optional('backoffFile'):Use(str),
                        #run Sensitivity Analysis #GG2
                        Optional('useSA', default=False):Use(tobool),
                        #set initial integration step #GG2
                        Optional('initialIntStep', default=0.0):Use(float),
                        #minimum operating mode duration #GG2
                        Optional('deltatmin', default=0.0):Use(float),
