...
def testA123():
    ...
    def sigma(c):
        ...
        b5=0.3066
        c5=0.3868
        out=gaubian(c,a1,b1,c1)+gaubian(c,a2,b2,c2)+gaubian(c,a3,b3,c3)+gaubian(c,a4,b4,c4)+gaubian(c,a5,b5,c5)
        return out  # S/m
    
    def gaubian(x,a,b,c):
        
        arg=(x-b)/c
        return a*np.exp(-pow(arg,2))
